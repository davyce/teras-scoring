...
import {
  ...
  BookOpen,
  Database,
  BarChart2, // ⭐ NOUVEAU - Icône Analytics RAG
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      >
        ...
        <div className="flex items-center gap-3 h-16 px-6 border-b border-gray-200 dark:border-gray-700">
          <img src={logoTeras} alt="TERAS Logo" className="w-8 h-8" />
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">TERAS Admin</h1>
            <p className="text-xs text-gray-500 dark:text-gray-400">Système d'administration</p>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500">© 2025 TERAS System</p>
        </div>
      </aside>
      ...
      <div className={`flex-1 flex flex-col transition-all duration-200 ${isSidebarOpen ? 'lg:ml-64' : ''}`}>
        {/* Top Bar */}
        <header className="sticky top-0 z-40 h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
          <div className="flex items-center justify-between h-full px-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 lg:hidden">
                <img src={logoTeras} alt="TERAS" className="w-6 h-6" />
                <span className="font-bold text-gray-900 dark:text-white">TERAS</span>
              </div>
            </div>
