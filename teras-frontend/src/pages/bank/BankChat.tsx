...
• "Performance des produits immobiliers"`;
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col">
      {/* ✅ Header avec Logo TERAS */}
      <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/50 rounded-2xl p-6 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            {/* ✅ Logo TERAS */}
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center p-2">
              <img 
                src={terasLogoUrl} 
                alt="TERAS" 
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">
                Analyse intelligente • Insights temps réel • Recommandations personnalisées
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="text-right">
              <p className="text-slate-400 text-xs">Contexte chargé</p>
              <p className="text-white text-sm font-semibold">{terasContext.totalLoans} crédits • {terasContext.totalClients} clients</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Messages Container */}
      <div className="flex-1 bg-slate-900/50 backdrop-blur-xl border border-slate-800/50 rounded-2xl overflow-hidden flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    {message.suggestions.map((suggestion, idx) => (
                      <button
                        ...
                        className="px-3 py-2 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 hover:border-blue-500/50 rounded-lg text-slate-300 hover:text-white text-sm transition-all"
                      >
                        {suggestion}
                      </button>
                    ))}
            ...
            <div className="flex gap-4">
              ...
              <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-400 text-sm">L'assistant analyse vos données...</span>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="border-t border-slate-800 p-4">
          <div className="flex items-center gap-3">
            <div className="flex-1 relative">
              <input
                ...
                placeholder="Posez votre question sur les crédits, clients, risques..."
                className="w-full px-4 py-3 pr-12 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20"
                disabled={isTyping}
              />
              <Sparkles className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" />
            </div>
            <button
              onClick={handleSend}
              disabled={!input.trim() || isTyping}
              className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
          ...
          <div className="flex flex-wrap gap-2 mt-3">
            <button
              onClick={() => setInput("Analyse complète du portefeuille")}
              className="px-3 py-1.5 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 rounded-lg text-slate-300 hover:text-white text-xs transition-all flex items-center gap-1.5"
            >
              <BarChart3 className="w-3.5 h-3.5" />
              Portefeuille
            </button>
            <button
              onClick={() => setInput("Liste des clients à risque élevé")}
              className="px-3 py-1.5 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 rounded-lg text-slate-300 hover:text-white text-xs transition-all flex items-center gap-1.5"
            >
            ...
            <button
              onClick={() => setInput("Opportunités de croissance identifiées")}
              className="px-3 py-1.5 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 rounded-lg text-slate-300 hover:text-white text-xs transition-all flex items-center gap-1.5"
            >
            ...
            <button
              onClick={() => setInput("Performance des produits financiers")}
              className="px-3 py-1.5 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 rounded-lg text-slate-300 hover:text-white text-xs transition-all flex items-center gap-1.5"
            >
            ...
            <button
              onClick={() => setInput("Insights score TERAS")}
              className="px-3 py-1.5 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 rounded-lg text-slate-300 hover:text-white text-xs transition-all flex items-center gap-1.5"
            >
