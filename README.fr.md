...
Créés localement via `backend/create_test_*.py` (voir Installation) — un compte par rôle (Admin, Banque, Gouvernement, Entreprise, Individuel), avec des données CEMAC synthétiques. Identifiants générés en local, jamais publiés ici.
